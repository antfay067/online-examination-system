...
<title>Ready For Final? || FEEDBACK </title>
...
<div class="col-lg-6">
<span class="logo">Ready For Final?</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">Daffodil@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/daffodil.jpg" width=100 height=100 alt="Daffodil" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a  style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Dilruba Rumaisa,Sharmin Jahan Sila,Foysal Ahmed</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+880 1620446161</h4>
		<h4 style="font-family:'typo' ">dilruba35-2238diu.edu.bd</h4>
		<h4 style="font-family:'typo' ">Daffodil International University, Dhaka, Bangladesh.</h4></div></div>
		</p>
      </div>
