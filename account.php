...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>get start!</b></a>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/daffodil.jpg" width=100 height=100 alt="Dilruba Rumaisa" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a  href="https://www.facebook.com/dilrubarumaisa.aronii" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Dilruba2238@diu.edu.bd</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+880 1600000000</h4>
		<h4 style="font-family:'typo' ">dilruba2238@diu.edu.bd</h4>
